...
<div class="table-responsive">
    ...
    <table class="table table-bordered table-hover table-striped" style="table-layout: fixed">
        ...
        if(isset($_POST['submit']))
        {
            ...
            <h3 align="center"><br><br><br><br><br><br><br><br><br><br><br><br>Freelancer Details</h3>
            <?php
            ...
            $check_query="select * from freelancer WHERE email='$semail'";
            $run_que=mysqli_query($dbcon,$check_query);

            if(mysqli_num_rows($run_que)==0)
            {
                echo "<script>alert('There is no data with this email id or type in our database.')</script>";
                exit();
            }
            
            
            $view_freelancer_query="select * from freelancer where type = '$user_type' and email = '$semail'";
