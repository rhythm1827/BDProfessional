  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      <div class="table-responsive">
        ...
        $view_offer_query="select * from offer where email = '$email'";
        ...
        <div class="list-group">
              <a href="#" class="list-group-item active">
                ...
                <h4 class="list-group-item-heading">Offer Title: <?php echo $title; ?></h4>
                <h4 class="list-group-item-heading">Offer Value: <?php echo $money; ?></h4>
                <h5 class="list-group-item-heading"><b>Offer given by: <?php echo $email; ?></b></h5>
                <p class="list-group-item-text">Description: <?php echo $description; ?></p>
              </a>
        </div>
       <?php }?>
